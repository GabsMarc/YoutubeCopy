...
export function Card() {
    ...
    return (
        <div className={`flex  flex-col mb-4 ${sideBarType === true ? 'w-[382px]' : 'w-[425px]'} `}>
            <div className={`bg-black rounded-[15px] ${sideBarType === true ? 'w-[382px] h-[218px]' : 'w-[425px] h-[240px]'} `}></div>
